...
const HtmlSerializer = function (type, element, content, children) {
    console.log(type, element, children, content)
    switch (type) {
        case Elements.heading1: return <Heading type="h1" children={children.join('')} />;
        case Elements.heading2: return <Heading type="h2" children={children.join('')} />;
        ...
        case Elements.paragraph: return <Paragraph children={[element]} />;
    ...
    `);
        case Elements.hyperlink:
            ...
            return <Links url={linkUrl} children={children.join('')} />
        case Elements.label:
